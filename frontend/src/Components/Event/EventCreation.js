				...
				<div className="eventDetails">
					...
					<div className="eventTitle">
						...
						<input
							...
							name="event-title"
							onChange={(e) =>
								props.dispatch(setEventTitle(e.target.value))
							}
							required
						/>
					</div>
					<div className="eventDateTime">
						...
						<input
							type="datetime-local"
							onChange={(e) =>
								props.dispatch(setEventDate(e.target.value))
							}
							defaultValue={props.event.eventDayTime}
							required
						/>
					</div>
					...
					{!created ? (
						...
						<Redirect to={`/EventView/${props.event.id}`} />
					)}
				</div>
